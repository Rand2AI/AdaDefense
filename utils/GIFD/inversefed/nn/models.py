...
def construct_model(model, num_classes=10, seed=None, num_channels=3, modelkey=None):
    ...
    if model in ["ConvNet", "ConvNet64"]:
        ...
        model = ResNet(
            torchvision.models.resnet.BasicBlock, [3, 3, 3], num_classes=num_classes, base_width=16 * 4, pool="max"
        )
        ...
        model = torchvision.models.MobileNetV2(
            num_classes=num_classes, inverted_residual_setting=inverted_residual_setting, width_mult=1.0
        )
