...
def options():
    ...
    parser.add_argument(
        "--epochs", default=120, type=int, help="If using a trained model, how many epochs was it trained?"
    )

    parser.add_argument(
        "--num_images", default=1, type=int, help="How many images should be recovered from the given gradient."
    )
    ...
    parser.add_argument(
        ...
        default=0,
        type=int,
        help="Accumulation 0 is rec. from gradient, accumulation > 0 is reconstruction from fed. averaging.",
    )
