...
def acc_loss():
    ...
    for dataset in datasets:
        for network in networks:
            with_path = f"/home/hans/WorkSpace/Data/Models/AdaDefense/AdaDefense/{dataset}/"
            with_defence_acc = []
            with_defence_loss = []
            without_defence_acc = []
            ...
            save_path = f"/home/hans/SynologyDrive/PhD/Paper/MyPaper/FedKL/Paper/FIgures/acc_loss/{dataset}-{network}"
            ...
            plt.plot(
                list(range(0, 200, int(200 / min_num_loss)))[:min_num_loss], with_defence_loss, "or-", label=f"with KL"
            )
            plt.plot(
                list(range(0, 200, int(200 / min_num_loss)))[:min_num_loss],
                without_defence_loss,
                "^b:",
                label=f"without KL",
            )
